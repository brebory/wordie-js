    ...
    String.prototype.numToSymbol = function() {
        ...
        if(this.length > 1) {
            console.log("numToSymbol can only be called on strings of length 0");
            return;
        }  else {
    ...
    var testPassWordifier = function(str) {
		var testPassWordifier = new PassWordifier(str);
        expected = "t5S@0";
        actual = testPassWordifier.passWordify();
		console.log(expected === actual);	
	};
